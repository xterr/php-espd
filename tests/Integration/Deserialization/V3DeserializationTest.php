...
final class V3DeserializationTest extends TestCase
{
    ...
    #[Test]
    public function v3RequestDeserializesWithNonNullCriterionTypeCodes(): void
    {
        ...
        self::assertGreaterThan(0, $nonNullCount, 'At least some v3.3.0 criteria should have non-null CriterionTypeCode');
    }

    #[Test]
    public function v3CodesAreNotLegacy(): void
    {
        $xml = self::fixture('ESPD-Request.xml');
        $request = self::$deserializer->deserialize($xml, QualificationApplicationRequest::class);
        ...
        foreach ($request->getTenderingCriterions() as $criterion) {
            ...
            if ($code !== null) {
                self::assertFalse($code->isLegacy(), sprintf('V3 code "%s" should not be legacy', $code->value));
            }
        }
    }

    #[Test]
    public function v3ResponseDeserializesWithNonNullCriterionTypeCodes(): void
    {
        ...
        self::assertGreaterThan(0, $nonNullCount, 'At least some v3.3.0 response criteria should have non-null CriterionTypeCode');
    }
}
